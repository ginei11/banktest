...
object Dependencies {
    ...
    const val OK_HTTP3_BOOM = "com.squareup.okhttp3:okhttp-bom:${Versions.OK_HTTP3_BOOM}"
    const val OK_HTTP3 = "com.squareup.okhttp3:okhttp"
    const val OK_HTTP3_INTERCEPTOR = "com.squareup.okhttp3:logging-interceptor"
...
fun DependencyHandler.retrofit() {
    ...
    add("implementation", Dependencies.OK_HTTP3)
    add("implementation", Dependencies.OK_HTTP3_INTERCEPTOR)
    add("implementation", platform(Dependencies.OK_HTTP3_BOOM))
